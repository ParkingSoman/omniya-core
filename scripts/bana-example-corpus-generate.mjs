...
const reviewedOperationIds = new Map(Object.entries({
  ...
  '14-111': ['script.superscript', 'script.baseline'],
  '14-112': ['script.subscript', 'script.superscript', 'comparison.less'],
  '14-113': ['script.superscript', 'comparison.less'], '14-114': ['script.sub-sub'],
  '14-115': ['script.superscript', 'script.subscript'], '14-116': ['script.subscript'],
  '14-117': ['script.subscript'], '14-118': ['script.superscript'],
  '14-119': ['script.superscript'], '14-120': ['script.superscript'],
  '14-121': ['script.sup-sub'],
