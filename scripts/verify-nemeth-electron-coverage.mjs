...
const required = [
  ...
  'Nemeth left-subscript choice creates multiscripts and MathJax edits the owned base',
  'Nemeth typeform scope creation and MathJax inner editing preserve the bold MathML scope',
  'Nemeth comparison creation and MathJax relation navigation edit preserve both operands',
  ...
  'Nemeth integral creation and MathJax sign navigation edit preserve the local follow-up structure',
