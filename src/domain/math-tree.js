...
const SAFE_ATTRIBUTES = new Set(['xmlns', 'data-omniya-id', 'data-omniya-hole', 'data-omniya-owner', 'data-omniya-role', 'data-omniya-group', 'data-omniya-fraction-kind', 'data-omniya-fraction-order', 'data-omniya-shape-kind', 'data-omniya-shape-modification', 'data-omniya-nemeth-intent', 'data-omniya-radical-order', 'data-omniya-binomial', 'intent', 'width', 'height', 'stretchy', 'displaystyle', 'scriptlevel', 'linethickness', 'open', 'close', 'notation', 'mathvariant', 'rowalign', 'columnalign', 'columnwidth', 'columnspan', 'rowspan', 'fence', 'separator', 'accent', 'movablelimits', 'symmetric', 'bevelled', 'lspace', 'rspace']);
