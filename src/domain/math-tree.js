...
const SAFE_ATTRIBUTES = new Set(['xmlns', 'data-omniya-id', 'data-omniya-hole', 'data-omniya-owner', 'data-omniya-role', 'width', 'height', 'stretchy', 'displaystyle', 'scriptlevel', 'linethickness', 'open', 'close', 'notation', 'mathvariant', 'rowalign', 'columnalign', 'columnwidth', 'columnspan', 'rowspan', 'fence', 'separator', 'accent', 'movablelimits', 'symmetric', 'bevelled', 'lspace', 'rspace']);
