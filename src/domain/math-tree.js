...
const SAFE_ATTRIBUTES = new Set(['xmlns', 'data-omniya-id', 'data-omniya-hole', 'data-omniya-owner', 'data-omniya-role', 'data-omniya-group', 'data-omniya-fraction-kind', 'data-omniya-fraction-order', 'data-omniya-shape-kind', 'data-omniya-shape-modification', 'data-omniya-nemeth-intent', 'data-omniya-hebrew-zero', 'data-omniya-projection-cells', 'data-omniya-nemeth-cells', 'data-omniya-nemeth-open', 'data-omniya-nemeth-separator', 'data-omniya-nemeth-close', 'data-omniya-nemeth-prefix', 'data-omniya-nemeth-index-prefix', 'data-omniya-nemeth-index-cells', 'data-omniya-typeform-close-cells', 'data-omniya-radical-order', 'data-omniya-binomial', 'data-omniya-script-comma', 'intent', 'width', 'height', 'stretchy', 'displaystyle', 'scriptlevel', 'linethickness', 'open', 'close', 'notation', 'mathvariant', 'rowalign', 'columnalign', 'columnwidth', 'columnspan', 'rowspan', 'fence', 'separator', 'accent', 'movablelimits', 'symmetric', 'bevelled', 'lspace', 'rspace']);
