...
const MAPPINGS = [
  ...
  token('operator.minus', ['⠤'], ['20.6'], '−'),
  token('operator.equals', ['⠨', '⠅'], ['21.1'], '='),
  token('comparison.less', ['⠐', '⠅'], ['21.5'], '<'),
  token('comparison.greater', ['⠨', '⠂'], ['21.5'], '>'),
  ...
  open('fraction.start.simple', ['⠹'], ['13.1', '13.2'], 'mfrac', ['numerator', 'denominator']),
