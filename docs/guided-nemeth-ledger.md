...
| Letters and numerals | Rules 3, 5, 6 | English, Greek, ordinary German Fraktur (not bold Fraktur), Hebrew aleph, Russian ell/sha, lower-cell Nemeth numerals, bounded non-decimal-base digits (3.6), uppercase Roman numeral local mode (3.11), capitalization, and bounded alphabet indicators implemented; ordinal, ordinary plural, possessive, and table/diagram contexts remain document or context-policy work | number indicator, base digits, Roman sequence, capitalization, non-English alphabet, and invalid-context fixtures |
