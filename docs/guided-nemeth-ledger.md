...
| Multipurpose indicator | Rule 24 | local baseline/multipurpose context selection implemented; modifier entry, baseline numerals, numeric script return, decimal-return (24.1.g), comparison-horizontal (24.1.f), adjacent-bar (24.1.i), and horizontal-tilde (24.1.k) one-symbol follow-ups covered; operation-spacing, tally/punctuation, and polygon/numeral combinations remain pending; erratum 24.1.e applied (deleted) | Appendix B combinations |
