...
| Typeforms and punctuation | Rules 7, 8 | punctuation token families and local letter/number typeform modes implemented; phrase-level typeform boundaries and alphabetic-indicator combinations pending | exact official examples and source-linked diagnostics |
...
| Shapes and functions | Rules 17, 18 | atomic shape tokens implemented; function names remain compositional tokens and abbreviated-function context pending | named and abbreviated functions |
...
| Multipurpose indicator | Rule 24 | local baseline/multipurpose context selection implemented; modifier entry and numeral/typeform contexts covered; remaining combinations pending | Appendix B combinations |
