...
| Reference signs and abbreviations | Rules 9, 10 | reference-sign tokens implemented; abbreviation context, contractions, punctuation, and spacing policies remain pending | compound-symbol fixtures |
...
| Fractions | Rule 13 | simple, complex, hypercomplex, and mixed structural openings implemented; continued-fraction and spatial-fraction forms are pending/deferred with Rule 25 | nested fraction depths 2, 8, 32 and terminators |
