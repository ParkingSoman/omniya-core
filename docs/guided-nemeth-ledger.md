...
| Grouping | Rule 19 | round, enlarged, half, barred, bold, angle, and vertical grouping signs are local tokens; Rule 19.2 horizontal signs remain explicitly pending because they require a selected over/under expression scope | paired boundaries and exact focus restoration |
