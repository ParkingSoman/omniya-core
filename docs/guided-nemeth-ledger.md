...
| Comparisons and arrows | Rules 21, 22 | source-backed core relations, the published Rule 21.9 modified-comparison table, vertically/horizontally compounded comparisons, Rule 15.9 comparison superposition, and official directional/diagonal/shaft examples use bounded local rows; any unlisted compound remains a standards-review item | exact Rule 21.9 source rows, independent Braille projections, direct BANA arrow fixtures, ambiguity and compound comparison fixtures |
